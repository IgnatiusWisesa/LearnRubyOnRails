...
ActiveRecord::Schema[8.0].define(version: 2025_08_30_015856) do
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.index ["user_id", "reactable_type", "reactable_id", "kind"], name: "idx_unique_reaction_per_user_reactable_kind", unique: true
